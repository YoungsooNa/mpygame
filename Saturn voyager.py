...
def main():
    ...
    keymap = []
    ship = [0, 0]
    scope_image = pygame.image.load("./images/scope.png")
    rock_image = pygame.image.load("./images/rock.png")

    score_font = pygame.font.SysFont(None, 36)
    sys_font = pygame.font.SysFont(None, 72)
    message_over = sys_font.render("GAME OVER!!", True, (0, 255, 255))
    message_rect = message_over.get_rect()
    message_rect.center = (400, 400)
    pygame.mixer.music.load('./images/Escape.mp3')
    ...
    while True:
        ...
        score_image = score_font.render(score_str, True, (0, 255, 0))
